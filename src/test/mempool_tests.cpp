...
public:
    ...
    using CTxMemPool::ROLLING_FEE_HALFLIFE;
};
...
BOOST_AUTO_TEST_CASE(MempoolSizeLimitTest)
{
    ...
    std::vector<CTransactionRef> vtx;
    SetMockTime(42);
    SetMockTime(42 + MemPoolTest::ROLLING_FEE_HALFLIFE);
    BOOST_CHECK_EQUAL(pool.GetMinFee(1).GetFeePerK(), maxFeeRateRemoved.GetFeePerK() + 1000);
    // ... we should keep the same min fee until we get a block
    pool.removeForBlock(vtx, 1);
    SetMockTime(42 + 2*MemPoolTest::ROLLING_FEE_HALFLIFE);
    BOOST_CHECK_EQUAL(pool.GetMinFee(1).GetFeePerK(), llround((maxFeeRateRemoved.GetFeePerK() + 1000)/2.0));
    // ... then feerate should drop 1/2 each halflife

    SetMockTime(42 + 2*MemPoolTest::ROLLING_FEE_HALFLIFE + MemPoolTest::ROLLING_FEE_HALFLIFE/2);
    ...
    SetMockTime(42 + 2*MemPoolTest::ROLLING_FEE_HALFLIFE + MemPoolTest::ROLLING_FEE_HALFLIFE/2 + MemPoolTest::ROLLING_FEE_HALFLIFE/4);
    ...
    SetMockTime(42 + 7*MemPoolTest::ROLLING_FEE_HALFLIFE + MemPoolTest::ROLLING_FEE_HALFLIFE/2 + MemPoolTest::ROLLING_FEE_HALFLIFE/4);
    BOOST_CHECK_EQUAL(pool.GetMinFee(1).GetFeePerK(), 1000);
    // ... but feerate should never drop below 1000

    SetMockTime(42 + 8*MemPoolTest::ROLLING_FEE_HALFLIFE + MemPoolTest::ROLLING_FEE_HALFLIFE/2 + MemPoolTest::ROLLING_FEE_HALFLIFE/4);
